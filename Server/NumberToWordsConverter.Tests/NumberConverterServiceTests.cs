...
public class NumberConverterServiceTests
{
    ...
    [InlineData("18446744073709551615.15", 
        ...
        "SIX HUNDRED AND FIFTEEN DOLLARS AND FIFTEEN CENTS")]
    [InlineData("6543212.34", 
        "SIX MILLION FIVE HUNDRED AND FORTY-THREE THOUSAND " +
        "TWO HUNDRED AND TWELVE DOLLARS AND THIRTY-FOUR CENTS")]
    ...
    [InlineData("100050000", "ONE HUNDRED MILLION FIFTY THOUSAND DOLLARS")]
